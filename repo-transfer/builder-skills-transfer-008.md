# Builder Skills Repository Transfer — Part 008 of 011
...
============================================================
FILE: helpers/assets/vendor-cisco-ios.json
DIRECTORY: helpers/assets/
FILENAME: vendor-cisco-ios.json
============================================================
SHA256: 1c072dfb95ca55d70687757b91e545509bc9d61880282d97ba34ffec473ef343
...
````json
{
  ...
  "components": [
    ...
    },
    {
      ...
      "document": {
        ...
        "createdBy": null,
        "lastUpdated": 1782331355621,
        "lastUpdatedBy": "mike.elrom@itential.com"
      }
    },
    {
      "iid": 9,
      "reference": "@66d0304521161b4df2717497: Pre and Post Checks",
      "type": "mopCommandTemplate",
      "folder": "/Software Upgrade",
      "document": {
        "tags": [],
    ...
    },
    {
      ...
      "document": {
        ...
        "lastUpdated": "2026-06-24T20:02:35.261Z",
        "createdBy": {
    ...
    {
      "iid": 16,
      "reference": "bc844559-cc86-4e45-9937-a1e0ad1cc8c5",
      "type": "workflow",
      "folder": "/Software Upgrade",
      "document": {
        "name": "IOS Upgrade",
        "tasks": {
          ...
          "bdec": {
            ...
            "variables": {
              "incoming": {
                "template": "@66d0304521161b4df2717497: Pre and Post Checks",
                "variables": "$var.a1ef.merged_object",
          ...
          "fe4a": {
            ...
            "variables": {
              "incoming": {
                "template": "@66d0304521161b4df2717497: File Verification",
                "variables": "$var.a1ef.merged_object",
                "devices": "$var.job.device"
              },
              "outgoing": {
          ...
          "d584": {
            ...
            "variables": {
              "incoming": {
                "template": "@66d0304521161b4df2717497: Reload",
                "variables": "$var.a1ef.merged_object",
                "devices": "$var.job.device"
              },
              "outgoing": {
          ...
          "0e8c": {
            ...
            "variables": {
              "incoming": {
                "template": "@66d0304521161b4df2717497: Show Version",
                "variables": "$var.a1ef.merged_object",
                "devices": "$var.job.device"
              },
              "outgoing": {
        ...
        "type": "automation",
        "font_size": 12,
        "last_updated": "2026-06-25T09:48:15.135Z",
        "last_updated_by": {
          "provenance": "CloudAAA",
          "username": "mike.elrom@itential.com",
          "firstname": "Mike",
        ...
        "uuid": "418282bc-e8db-4473-ae38-5df508c57e76",
    ...
    {
      "iid": 18,
      "reference": "2919e1ab-5965-4ebb-a46c-cae7060219b8",
      "type": "workflow",
      "folder": "/Port Turn Up",
      "document": {
        "name": "Port Turn Up",
        "tasks": {
          ...
          "bdec": {
            ...
            "variables": {
              "incoming": {
                "template": "@66d0304521161b4df2717497: Pre and Post Checks",
                "variables": "$var.2d67.merged_object",
                "devices": "$var.job.device"
              },
              "outgoing": {
                "mop_template_results": "$var.job.preCheckOutput"
          ...
          "bde4": {
            ...
            "variables": {
              "incoming": {
                "name": "@66d0304521161b4df2717497: Port Turn Up",
                "variables": "$var.2d67.merged_object",
                "castDataType": "string"
              },
              "outgoing": {
        ...
        "type": "automation",
        "font_size": 12,
        "last_updated": "2026-06-25T09:51:30.410Z",
        "lastUpdatedVersion": "5.55.5",
        "uuid": "97c004c3-1b8a-458a-831d-418cbc17b768",
        "createdVersion": "5.55.5",
        "last_updated_by": {
          "provenance": "CloudAAA",
          "username": "mike.elrom@itential.com",
    ...
    {
      "iid": 20,
      "reference": "00c262a7-b488-45ad-9040-d06ecb89a95a",
      "type": "workflow",
      ...
      "document": {
        ...
        "type": "automation",
        "font_size": 12,
        "last_updated": "2026-06-24T20:02:35.267Z",
        "last_updated_by": {
          "provenance": "CloudAAA",
          "username": "mike.elrom@itential.com",
          "firstname": "Mike",
        ...
        "uuid": "5f5d52f1-77b3-431d-826c-8a7a452c56ea",
    ...
    {
      "iid": 22,
      "reference": "d8195c49-5ec7-4b13-b260-9b9bee15b91c",
      "type": "workflow",
      ...
      "document": {
        ...
        "lastUpdatedVersion": "4.69.69",
        "uuid": "09b1fed1-3b11-413a-9bc9-41b4a47923b0",
    ...
    {
      "iid": 23,
      "reference": "f8b81305-5a8c-45b5-887c-272bc0127d09",
      "type": "workflow",
      "folder": "/Inventory Management",
      "document": {
        ...
        "lastUpdatedVersion": "4.69.69",
        "uuid": "438bcfdc-6767-4543-8b72-6f3a8b4022a4",
    ...
    {
      "iid": 17,
      "reference": "6a1dbb9a62b073861f97160e",
      "type": "jsonForm",
      "folder": "/Software Upgrade",
      "document": {
        "id": "6a1dbb9a62b073861f97160e",
        "created": "2026-06-01T17:04:26.462Z",
        "createdBy": "mike.elrom@itential.com",
        "lastUpdated": "2026-06-24T20:02:35.269Z",
        "lastUpdatedBy": "mike.elrom@itential.com",
        "name": "Upgrade Form",
        "description": "",
        "struct": {
    ...
    {
      "iid": 19,
      "reference": "6a1dde0762b073861f97160f",
      "type": "jsonForm",
      "folder": "/Port Turn Up",
      "document": {
        "id": "6a1dde0762b073861f97160f",
        "created": "2026-06-01T19:31:19.441Z",
        "createdBy": "mike.elrom@itential.com",
        "lastUpdated": "2026-06-25T17:37:35.973Z",
        "lastUpdatedBy": "mike.elrom@itential.com",
    ...
    {
      "iid": 21,
      "reference": "6a1de22962b073861f971610",
      "type": "jsonForm",
      "folder": "/Golden Configuration",
      "document": {
        "id": "6a1de22962b073861f971610",
  ...
  "createdBy": {
    "_id": "6a136cf149ee3647b2898f71",
    "provenance": "Local AAA",
    "username": "admin@itential",
    "missing": true
  },
  "lastUpdated": "2026-06-30T04:18:55.309Z",
  "lastUpdatedBy": {
    "_id": "6a3c303cdd8730559c46dc8b",
    "provenance": "CloudAAA",
    "username": "mike.elrom@itential.com"
  ...
  "referencedComponentHashes": [
    {
      "type": "trigger",
      "reference": "6a1dcad4c48aa7c8f68765fe",
      "name": "IOS Upgrade",
      "hash": "2ccd4338fae644115f958d0b9e63bf48dad28186"
    },
    {
      "type": "trigger",
      "reference": "6a1ddf16c48aa7c8f6876600",
      "name": "Port Turn Up",
      "hash": "695cb476194d18ad2a32cdaa026712b6f9b71b12"
    },
    {
      "type": "automation",
      "reference": "6a1dbd9bc48aa7c8f68765fd",
      "name": "IOS Software Upgrade",
      "hash": "e203305c0b994d3a099923503a0c76d4c530e816"
    },
    {
      "type": "automation",
      "reference": "6a1ddf01c48aa7c8f68765ff",
      "name": "IOS Port Turn Up",
      "hash": "d8921fc952b72296c423badc15e3b0e7e6afb737"
    }
  ]
}
